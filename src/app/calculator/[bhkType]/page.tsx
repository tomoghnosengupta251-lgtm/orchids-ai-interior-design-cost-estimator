                    ...
                    >
                      <label className="flex items-start gap-3 p-5 rounded-xl border-2 border-cyan-500/30 bg-gradient-to-br from-indigo-900/50 to-purple-900/50 hover:border-cyan-400 hover:shadow-lg hover:shadow-cyan-500/30 transition-all cursor-pointer group">
                        <Checkbox
                          ...
                          checked={selectedOptions.includes(option.id)}
                          onCheckedChange={() => handleOptionToggle(option.id)}
                          className="mt-1 border-cyan-400 data-[state=checked]:bg-gradient-to-r data-[state=checked]:from-cyan-500 data-[state=checked]:to-blue-600"
                        />
                        <div className="flex-1">
      ...
      <div className="pt-24 pb-12 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            >
              <h1 className="text-5xl md:text-7xl font-black bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent mb-4 animate-gradient bg-[length:200%_auto]">
                Customize Your {config.type.toUpperCase()}
              </h1>
            </motion.div>
