    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      <nav className="fixed top-0 w-full bg-slate-950/80 backdrop-blur-2xl z-50 border-b border-amber-500/20">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link
            href="/"
            className="flex items-center gap-2 text-amber-400 hover:text-amber-300 transition-all hover:scale-105 group"
          >
                      ...
                      <label className="flex items-start gap-3 p-5 rounded-xl border-2 border-cyan-500/30 bg-gradient-to-br from-indigo-900/50 to-purple-900/50 hover:border-cyan-400 hover:shadow-lg hover:shadow-cyan-500/30 transition-all cursor-pointer group">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center justify-between mb-2">
                            <span className="font-bold text-cyan-100 group-hover:text-cyan-50 transition-colors">
                              {option.name}
                            </span>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 space-y-6">
                <Card className="p-6 bg-gradient-to-br from-slate-800 to-slate-900 border-2 border-amber-500/40 shadow-2xl shadow-amber-500/30 backdrop-blur-xl">
                  <h3 className="text-2xl font-black text-transparent bg-gradient-to-r from-amber-400 to-orange-500 bg-clip-text mb-6">
                    Cost Breakdown
                  </h3>
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    {selectedOptions.map((optionId) => {
                      ...
                      return (
                        <div
                          key={optionId}
                          className="flex justify-between text-slate-200 text-sm p-2 rounded-lg bg-slate-900/30"
                        >
      ...
      <section className="py-16 px-6 bg-gradient-to-br from-violet-950 via-fuchsia-950 to-purple-950 text-white border-t-2 border-fuchsia-500/30">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-black mb-6 text-transparent bg-gradient-to-r from-cyan-400 via-fuchsia-400 to-pink-400 bg-clip-text">
            Ready to Start?
          </h2>
