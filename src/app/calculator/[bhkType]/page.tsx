            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {recommendations.length > 0 && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                >
                    <Card className="p-6 bg-gradient-to-br from-slate-800 to-slate-900 border-2 border-green-500/40 shadow-xl shadow-green-500/20 backdrop-blur-xl">
                      <h3 className="text-xl font-black text-transparent bg-gradient-to-r from-green-400 to-emerald-500 bg-clip-text mb-4 flex items-center gap-2">
                      ...
                      <ul className="space-y-3">
                        {recommendations.map((rec, index) => (
                          <motion.li 
                            ...
                            animate={{ opacity: 1, x: 0 }}
                            transition={{ delay: index * 0.1 }}
                            className="text-sm text-slate-100 flex items-start gap-3 p-3 rounded-lg bg-slate-900/50"
                          >
      ...
      <div className="pt-24 pb-12 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-6">
              <Card className="p-6 bg-gradient-to-br from-slate-800 to-slate-900 backdrop-blur-xl border-2 border-amber-500/20 shadow-2xl shadow-amber-500/10">
                  <h2 className="text-3xl font-black text-transparent bg-gradient-to-r from-amber-400 to-orange-500 bg-clip-text mb-4 flex items-center gap-3">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {config.options.map((option, index) => (
                      <motion.div
                        ...
                        whileHover={{ scale: 1.02 }}
                      >
                        <label className={`flex items-start gap-3 p-5 rounded-xl border-2 transition-all cursor-pointer group ${
                          selectedOptions.includes(option.id)
                            ? "border-amber-500 bg-gradient-to-br from-amber-900/50 to-orange-900/50 shadow-lg shadow-amber-500/30"
                            : "border-slate-700 bg-slate-800/50 hover:border-amber-500/50 hover:shadow-lg hover:shadow-amber-500/20"
                        }`}>
                        <Checkbox
                          checked={selectedOptions.includes(option.id)}
                          onCheckedChange={() => handleOptionToggle(option.id)}
                        ...
                        />
                          <div className="flex-1">
                            <div className="flex items-center justify-between mb-2">
                              ...
                              <span className="text-sm font-black text-transparent bg-gradient-to-r from-amber-400 to-orange-500 bg-clip-text">
                                +{formatCurrency(option.baseCost)}
                              </span>
                            </div>
